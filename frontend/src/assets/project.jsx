      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 520px) {
          ...
          .ap-date-row { grid-template-columns: 1fr; }
          .ap-type-group { flex-direction: column; }
        }
      `}</style>
        ...
        <div className="ap-card">
          ...
          {success && (
            <div className="ap-success">
              ...
              <div>
                ...
                <div className="ap-success-sub">Ready for workspace configuration.</div>
              </div>
            </div>
          )}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div className="ap-field">
              ...
              <input
                className={`ap-input${errors.projectName ? " err" : ""}`}
                name="projectName"
                value={formData.projectName}
                onChange={handleChange}
                placeholder="e.g. Website Redesign Pipeline"
                autoFocus
              />
            ...
            <div className="ap-date-row">
              <div className="ap-field">
                ...
                <input
                  className={`ap-input${errors.startDate ? " err" : ""}`}
                  name="startDate"
              ...
              <div className="ap-field">
                ...
                <input
                  className={`ap-input${errors.endDate ? " err" : ""}`}
                  name="endDate"
            ...
            <div className="ap-field">
              ...
              <div className="ap-type-group">
                {["hourly", "daily", "monthly"].map((t) => (
                  <button
                    key={t}
                    className={`ap-type-btn${formData.projectType === t ? " active" : ""}`}
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
                ...
                <div className="ap-field">
                  ...
                  <div className="ap-prefix-wrap">
                    ...
                    <input
                      className={`ap-input has-prefix${errors.expectedAmount ? " err" : ""}`}
                      name="expectedAmount"
                  ...
                  {formData.currency === "USD" && Number(formData.expectedAmount) > 0 && (
                    <div className="ap-usd-hint">
                      ≈ ₹{(Number(formData.expectedAmount) * USD_TO_INR).toLocaleString("en-IN", { maximumFractionDigits: 0 })} will be saved
                    </div>
                  )}
                </div>
              </div>
            ...
            {/* Hourly / Daily info hint */}
            {(formData.projectType === "hourly" || formData.projectType === "daily") && (
              <div className="ap-info-box">
                ℹ️ Rates and units for <strong>{typeConfig[formData.projectType].label}</strong> billing are configured per-month inside the dashboard.
              </div>
            )}
