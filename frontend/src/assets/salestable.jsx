      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .st-spinner {
          width: 28px;
          height: 28px;
          border: 2.5px solid #e8dece;
          border-top-color: #c97844;
          border-radius: 50%;
        ...
        @media (max-width: 768px) {
          .st-page { padding: 24px 14px 40px; }
            ...
            <div className="st-stat-methods">
              {['cash', 'upi', 'card'].map((src) => {
                ...
                return (
                  <span
                    key={src}
                    className="st-method-chip"
                    style={{ background: cfg.bg, color: cfg.color, borderColor: cfg.border }}
                  >
                    {cfg.icon} {cfg.label} · {sales.filter((s) => s.source === src).length}
                  </span>
                )
              })}
            </div>
            ...
            <table className="st-table">
              ...
              <tbody>
                {sales.map((sale, index) => {
                  const src = sourceConfig[sale.source] || sourceConfig.cash
                  ...
                  return (
                    <tr key={sale._id}>
                      ...
                      <td className="st-amount">₹{Number(sale.amount).toLocaleString('en-IN')}</td>
                      <td>
                        <span
                      ...
                      <td>
                        <div className="st-comment" title={sale.comment}>
                          {sale.comment || '—'}
                        </div>
                      </td>
