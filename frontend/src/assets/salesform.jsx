    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .sf-radio-face .opt-icon {
          font-size: 18px;
          line-height: 1;
        }

        .sf-radio-opt input:checked + .sf-radio-face {
          border-color: #c97844;
          background: #fff9f2;
          color: #a05e2a;
        }

        .sf-radio-opt:hover .sf-radio-face {
          border-color: #d4a070;
          color: #7a6050;
        }
        ...
        @media (max-width: 520px) {
          ...
          .sf-radio-group { flex-direction: column; }
        }
      `}</style>
        ...
        <div className="sf-card">
          ...
          <div className="sf-field" style={{ marginBottom: '20px' }}>
            <label className="sf-label" style={{ marginBottom: '10px' }}>
              Payment Method <span className="sf-required">*</span>
            </label>
          ...
          <div className="sf-field">
            ...
            <textarea
              ...
              name="comment"
              placeholder="Any remarks or notes about this sale..."
              value={form.comment}
              onChange={handleChange}
            />
          </div>
          ...
          <div className="sf-actions">
            <button className="sf-btn-cancel" onClick={() => navigate('/salestable')}>
              Cancel
            </button>
